...
struct
	(*Torna true solo se x è contenuto nella lista danta in input*)
  fun isIn(x,[])= false
  ...
  (*Prende in inputa una coppia di liste. Restituisce una lista di coppie dove la i-esima coppia rappresenta gli i-esimi elementi delle due liste prese in input*)
  fun zip([],l) = []
    | zip(l,[]) = []
